                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="needs-validation" action="{{ route('berita.insert_post') }}" method="POST" enctype="multipart/form-data" novalidate >
                                @csrf
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" id="validationCustom06" name="judul" placeholder="Masukkan Judul" required>
                                                <div class="invalid-feedback">
                                                    Masukkan Judul.
                                                </div>
                                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="file" class="form-control" id="validationCustom06" name="gambar" placeholder="Masukkan Gambar" required>
                                                <div class="invalid-feedback">
                                                    Masukkan Gambar.
                                                </div>
                                            </div>

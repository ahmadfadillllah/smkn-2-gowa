                ...
                <div class="header-left">
                    <form action="{{ route('dashboard.search') }}" method="get">
                        <div class="input-group search-area">
                            <input type="text" class="form-control" name="cari_siswa" placeholder="Cari nisn atau siswa">
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end of-visible">
                            ...
                            <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:100px;">
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media me-2">
                                                <img alt="image" width="50" src="{{ asset('admin/finlab.dexignzone.com/xhtml') }}/images/avatar/user.png">
                                            </div>
                                            <div class="media-body">
                                                <h6 class="mb-1">Administrator</h6>
                                                <small class="d-block">Gunakan web ini dengan bijak!</small>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <ul class="timeline">
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted" href="javascript:void(0);">
                                            <span>2023</span>
                                            <h6 class="mb-0">Web ini dilaunching.</h6>
                                        </a>
                                    </li>
                        ...
                        <div class="dropdown header-profile2">
                            <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="header-info2 d-flex align-items-center">
                                    ...
                                    <img src="{{ asset('admin/finlab.dexignzone.com/xhtml/images/avatar') }}/{{ Auth::user()->avatar }}" alt="">
                                </div>
                            </a>

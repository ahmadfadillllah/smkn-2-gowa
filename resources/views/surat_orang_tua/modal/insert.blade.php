<div class="modal fade" id="insertOrangTuaSiswa">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
           ...
           <form action="{{ route('surat_orang_tua.insert') }}" method="POST">
            @csrf
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control input-rounded" name="kegiatan" required>
                </div>
                <div class="mb-3">
                    <label for="">Tanggal Kegiatan</label>
                    <input type="date" class="form-control input-rounded" name="tanggal_kegiatan" placeholder="Masukkan Tanggal Surat" required>
                </div>
                <div class="mb-3">
                    <label for="">Tempat</label>
                    <input type="text" class="form-control input-rounded" name="tempat" required>
                </div>
                <div class="mb-3">
                    <label for="">Keterangan</label>
                    <input type="text" class="form-control input-rounded" name="keterangan" required>
                </div>
                <div class="mb-3">
